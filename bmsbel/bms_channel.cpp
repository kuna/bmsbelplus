...
bool
BmsChannel::IsBpmChangeChannel( void ) const
{
  return channel_number_.ToInteger() == 3;
}

bool
BmsChannel::IsInvisibilityObjectChannel( void ) const
{
  int c = channel_number_.ToInteger();
  return (
    // 31 -- 3Z, 41 -- 4Z
...
bool
BmsChannel::IsExtendedBpmChangeChannel( void ) const
{
  return channel_number_.ToInteger() == 8;
}
...
bool
BmsChannel::IsStopSequenceChannel( void ) const
{
  return channel_number_.ToInteger() == 9;
}

bool
BmsChannel::IsMineChannel() const
{
	int c = channel_number_.ToInteger();
	return (
		// D1 -- E9
